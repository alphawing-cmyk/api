...
SELECT id, custom_id, symbol, milliseconds, duration, open, low, high, close, adj_close, volume, vwap, timestamp, transactions, source, market, ticker_id
FROM historical
...
RETURNING id, custom_id, symbol, milliseconds, duration, open, low, high, close, adj_close, volume, vwap, timestamp, transactions, source, market, ticker_id
`

type InsertHistoricalBarParams struct {
	CustomID     string         `json:"custom_id"`
	TickerID     sql.NullInt32  `json:"ticker_id"`
	Symbol       string         `json:"symbol"`
