...
export const DeleteAction = ({ data }: any) => {
  ...
  const handleDelete = async () => {
    setSuccess(null);
    submit(
      { action: "delete_api_link", id: data.id },
      { method: "DELETE" }
    );
  };
  ...
  useEffect(() => {
    if (actionData && "success" in actionData && actionData.success) {
      toast({
        title: "Success",
        description: "Successfully deleted api connection.",
        variant: "success",
      });
      setIsOpen(false);
      ...
      toast({
        title: "Error",
        description: "Could not delete api connection, please try again.",
        variant: "destructive",
      });
    }
  }, [actionData]);
  ...
  return (
    <div className="flex justify-center">
      ...
      <Modal
        ...
        description="Once this api connection is deleted, all trade executions will stop"
        isOpen={isOpen}
        onClose={() => {
          setIsOpen(false);
        }}
